                                ...
                                <div class="collapse navbar-collapse  " id="navbarNav">
                                    ...
                                    <ul class="navbar-nav ">
                                        ...
                                        <li class="nav-item">
                                         ...
                                         <li class="nav-item">
                                            <a class="lang_link  ahover clr-pink" style="font-weight: bolder; " href="/index-tr.php">TR</a>
                                        </li>
                                         <li class="nav-item">
                                            <a class="lang_link  ahover clr-pink" style="font-weight: bolder; "  href="http://keremunce.great-site.net/">EN</a>
                                        </li>
                                    </ul>
                                </div>
                         ...
                         <script src="http://threejs.org/examples/js/libs/stats.min.js"></script>
                            ...
                            <div class=" container position-absolute  " style="top:30%;">
                                ...
                                <div class="content-header w-100 d-flex justify-content-center">
                                    <a href="https://github.com/Keremunce"  target=_blank>
...
<!--MAIN CONTENT-->    
   <div class="hakkinda-container">
            ...
            <div class="hakkinda-img revealup">
                <div><img src="assets/img/html5.png"></div>
            </div><!--hakkinda-img-->
    ...
    <div class="js-vue-container">
            ...
            <div class="vue-img ">
                <img src="assets/img/vuejs.png " class="revealright">
            </div><!--vue-img-->
