...
<head>
    ...
    <title>Kerem Ünce Kişisel Web Sitesi</title>
    <!--Meta-->  
                ...
                <nav class="row navbar fixed-top navbar-expand-lg navbar-light p-md-3 rounded-3" >
                    <div class="container" >
                        <div class="navbar-header">
                                ...
                                <div class="kerem">
                                    <a class="text-white navbar-brand font-weight-bolder content-zindex " href="#home">Kerem ÜNCE</a>
                                 </div>
                        </div> 
                                <div class="collapse navbar-collapse  " id="navbarNav">
                                    ...
                                    <ul class="navbar-nav ">
                                        <li class="nav-item">
                                            <a href="#home"  id="div1" class="nav-link text-white ahover behance smooth-scroll">AnaSayfa</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#about" id="div2" class="nav-link text-white ahover behance smooth-scroll">Hakkımda</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#contact" id="div3" class="nav-link text-white ahover smooth-scroll">İletişim</a>
                                        </li>
                                         <li class="nav-item">
...
<!--MAIN CONTENT-->    
   <div class="hakkinda-container">
            <div class="hakkinda reveal">
                <h1>Hakkımda</h1>
                <p>19 Aralık 2004'de İstanbul'un Bakırköy ilçesinde doğdum.İlköğretim dönemimi İstanbul/Pendik'de tamamlamamın ardından Pendik Türk Telekom Mesleki ve Teknik Anadolu Lisesi'ne girerek lise hayatıma başladım.
                Lisede C# ile tanıştım ama ardından kendimi daha çok frontend kısmına uygun gördüm.
                Okulda öğretildiği üzere kendi işimi görecek düzeyde Photoshop ve Animate bilgi sahibiyim.Dizilerden ve oyunlardan geliştirdiğim intermedite(B1) seviye ingilizceye sahibim. </p>
            </div><!--hakkinda-->
       ...
       <div class="html-css-container">
            ...
            <div class="html-css reveal">
                <h1>HTML&CSS</h1>
                <p>Kendimi HTML&CSS olarak tanımlıyorum, genel olarak bu dillerde daha çok pratik yapıyorum ve yazması tasarlaması animasyonlaması gerçekten zevkli geliyor. Güzel şeyler tasarlayıp tasarladığım renkleri animasyonları görmek beni daha çok mutlu ediyor o yüzden kariyer yolu seçerken backend'i tercih etmedim.Kararımdan mutluyum ve kendi gelişimimi görmek beni mutlu yapıyor. </p>
            </div><!--html-css-->
    ...
    <div class="js-vue-container">
            ...
            <div class="js-vue revealdown ">
                ...
                <p>Elbette, bir Frontend'in kesinlikle ve ağırlıklı olarak bilmesi gereken dil Javascript'tir. Açıkçası Javascript'te HTML&CSS'deki kadar pratiğim ve deneyimim yok, şimdilik statik web siteleri yapıyorum ve önümde bir staj yılı var. Bu projeden sonra hedefim vakit kaybetmeden Vue.js öğrenmeye ve uygulamaya başlamak olacak.   </p>
            </div><!--js-vue-->
            <div class="vue-img ">
    ...
    <div class="bilgi-container">
            <div>
                <h1>Nasıl biriyim?</h1>
                <p>Ben her parça bilgiye açık biriyim, gerçekten vaktim olsa bütün gün internette surflerim. Farklı şeyler, yerler deneyimlemek, görmek gezmek.Öğrendiklerimi ulaşabildiğim insanlara yaymak istiyorum. Bunu neden yapmak istiyorum, çünkü yararlıymış gibi hissetmeyi ve yardım etmeyi seviyorum. Onun dışında insiyatif alabilen <b>keşfetmeyi</b> ve <b>araştırmayı</b> seven ve bundan zevk alan bi kişiliğim.</p>
...
<!----------------------------------Projects------------>  
    ...
    <div id=" slider">  
        <div class="slides w-100">  
          ...
          <div class="btndiv">
                <a href="assets/Projects/JS-TIC-TAC-game/index.html" target="_blank" ><button class="neon-button " >>Projeye Git..</button></a>        
          </div>
         </div>
          ...
          <div class="btndiv">
                <a href="assets/Projects/Typing_Game/index.html"target="_blank" ><button class="neon-button  " >>Projeye Git..</button></a>   
            </div>
        </div>
          ...
          <img src="assets/img/ecommerce.png" width="100%"style="max-height: 35rem; position: relative;" />
            <div class="btndiv ">
                <a ><button class="neon-button" style="cursor: not-allowed;">>Yapım Aşamasında..</button></a>   
            </div>
...
<footer>
  <!-- Footer Text -->
    ...
    <div class="content-zindex">
      ...
      <div class="footer-copyright text-center text-secondary py-3"><a href="assets/MAIN/PP.html" class="text-secondary">Gizlilik Politikası </a>|<a class="text-secondary" href="assets/MAIN/KK.html"> Kullanım Koşulları </a>|<a class="text-secondary" href="assets/MAIN/Cookies.html"> Çerez Politikası</a>
      </div>
      <!-- Copyright -->
    </div>
